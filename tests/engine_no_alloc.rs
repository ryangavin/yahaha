...
fn preview_and_next_bar_style_change_do_not_allocate() {
    ...
    let controls = StyleControls { main: Some(1), intro: None, sync_start: None, sync_stop: Some(true), stop_acmp: Some(true), parts: Some(0b1011_1111), volumes: Some([90, 80, 100, 64, 100, 100, 100, 70]) };
