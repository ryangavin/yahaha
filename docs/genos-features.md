...
- **yahaha:** defaults to off (#128, owner): TAP TEMPO while playing sets the tempo. Section Reset has its own command and an assignable function (Style Section Reset).
