...
- **Voicing:**
  ...
  - Each string above takes the 3rd (the sus tone of a sus chord) if it reaches it and it is not yet sounding, else the lowest fret of a chord tone not yet sounding, the important ones first (5th and 7th; for five-note chords the 7th and tension), then the lowest chord tone. The 3rd goes first so that no voicing trades it for a tension on a lower fret: before that rule, 17 open-position chords (D9, A9, Am9, Dm9, D6/9, Dadd9 and others) lost their 3rd.
  - So the open position gives x32000 for CM7, x32010 for C, 320003 for G, xx0232 for D, x02210 for Am, 320001 for G7, x32333 for C9, xx0212 for D9 and x32344 for C7♯9, which keeps its major 3rd next to the ♯9.
...
- **Arpeggio:** "four-note arpeggio sounds" (RM p.30). The bass stays on string 6 or 5, and strings 1–4 take the fingering within reach that rises from the bass and, with it, sounds the 3rd, then the most chord tones. Every tone of a four-note chord sounds for 332 of the 336 four-note chords in the two main positions; All Purpose manages 254. A triad doubles its root.
- **Pitch-written sources (MOX_v2).** The 43 MOX_v2 Guitar rules are written as real fingerings, x32000 C E G B E for example. They are read as codes too: C as the bass, E as string 5, G as string 3, B as string 1, and the high E as string 5 one position up.
  ...
  - Over 308 of the 348 chords with a 3rd, it keeps the 3rd. When the bass sits on string 5, the E written on that string doubles the bass.
