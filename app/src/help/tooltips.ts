...
const catalog = {
  ...
  'fx.edit': {
    ...
    body: 'Opens this effect\'s own settings below the row: the reverb\'s time, pre-delay and tone, or the delay\'s note or time, feedback, tone and ping-pong. Choosing another type puts them back to that type\'s own values.',
