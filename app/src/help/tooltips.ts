...
const catalog = {
  ...
  'fx.param.reverb_time': {
    ...
    genos: 'Mixer › Effect › Edit › Reverb Time',
    keys: [],
    launchkey: 'FX knob page, knob 1',
  },
  'fx.param.pre_delay': {
    title: 'Pre-delay',
    body: 'A gap before the reverb starts, 0 to 200 ms: a longer one keeps the notes clear of their reverb, as in a bigger room. Each type starts at its own (Hall 22 ms); the tick marks it.',
    genos: 'Mixer › Effect › Edit › Initial Delay',
    keys: [],
    launchkey: 'FX knob page, knob 2',
  },
  'fx.param.reverb_tone': {
    title: 'Reverb tone',
    body: 'How bright the reverb tail is: the high cut inside the reverb, 1 to 20 kHz. Lower damps the highs sooner for a darker, warmer room; each type starts at its own (Hall 4.5 kHz).',
    genos: 'Mixer › Effect › Edit › High Damp',
    keys: [],
    launchkey: 'FX knob page, knob 3',
  },
  'fx.param.delay_sync': {
    title: 'Delay tempo sync',
    body: 'On, the echoes follow the style tempo at the Note value; off, they repeat at the free Time in milliseconds, whatever the tempo.',
    genos: 'Mixer › Effect › Edit › Tempo Delay / Delay',
    keys: [],
    launchkey: null,
  },
  'fx.param.delay_note': {
    title: 'Delay note',
    body: 'The echo time as a note value at the style tempo: 1/16, 1/8 triplet, 1/8, 1/4 triplet, dotted 1/8, 1/4, dotted 1/4 or 1/2. Used with tempo sync on; a tempo change glides the echoes to the new length.',
    genos: 'Mixer › Effect › Edit › Delay Time (note)',
    keys: [],
    launchkey: 'FX knob page, knob 4 (tempo sync on)',
  },
  'fx.param.delay_time': {
    title: 'Delay time',
    body: 'The echo time in milliseconds, 10 to 2000, used with tempo sync off. Changes glide, so the echoes bend to the new time rather than click.',
    genos: 'Mixer › Effect › Edit › Delay Time',
    keys: [],
    launchkey: 'FX knob page, knob 4 (tempo sync off)',
  },
  'fx.param.delay_feedback': {
    title: 'Delay feedback',
    body: 'How much of each echo comes back as the next one, 0 to 90%: 0 is a single echo, higher keeps them going longer (38% at start).',
    genos: 'Mixer › Effect › Edit › Feedback Level',
    keys: [],
    launchkey: 'FX knob page, knob 5',
  },
  'fx.param.delay_tone': {
    title: 'Delay tone',
    body: 'The high cut on the echoes, 1 to 20 kHz: each repeat passes through it again, so lower makes later echoes darker, like a tape echo (5 kHz at start).',
    genos: 'Mixer › Effect › Edit › High Damp',
    keys: [],
    launchkey: null,
  },
  'fx.param.ping_pong': {
    title: 'Ping-pong',
    body: 'On, the echoes bounce between left and right instead of each side repeating itself. Switching crossfades, so it never clicks.',
    genos: 'Mixer › Effect › Edit › Tempo Cross',
    keys: [],
    launchkey: null,
  },
  'fx.param.chorus_rate': {
    title: 'Chorus rate',
    body: 'How fast the chorus sweeps, 0.05 to 5 Hz: slow is a gentle shimmer, fast a vibrato-like warble. Each type starts at its own (Chorus 0.55 Hz); a change keeps the sweep where it is, so it never clicks.',
    genos: 'Mixer › Effect › Edit › LFO Frequency',
    keys: [],
    launchkey: 'FX knob page, knob 6',
  },
  'fx.param.chorus_depth': {
    title: 'Chorus depth',
    body: 'How far the chorus sweeps, 0 to 5 ms: more is a wider detune, 0 is no movement at all. Each type starts at its own (Chorus 2.2 ms); changes glide.',
    genos: 'Mixer › Effect › Edit › LFO Depth',
    keys: [],
