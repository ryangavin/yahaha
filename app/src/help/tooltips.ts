...
const catalog = {
  ...
  'browser.filter': {
    title: 'Filter',
    body: 'Type to filter by name or folder (not case-sensitive). ↑/↓ move, Enter loads, Esc closes without changing the style.',
    genos: null,
    keys: [],
    launchkey: null,
  },
  'browser.folder': {
    title: 'Folder',
    body: 'Shows only the styles in this folder. The folder a style is in is its category.',
  ...
  'browser.row': {
    title: 'Load style',
    body: 'Loads this style and closes the browser. While the band plays it keeps playing and follows your next chord in the new style. ▶ marks the style that\'s loaded.',
    genos: null,
    keys: [],
    launchkey: null,
  },
  'browser.close': {
    title: 'Close browser',
    body: 'Closes the browser without changing the style.',
    genos: null,
    keys: ['esc'],
    launchkey: null,
  },
  ...
  'ots.1': {
    title: 'OTS 1',
    body: 'Recalls the style\'s first suggested panel setup: voice, on/off, volume and octave for Right 1–3 and Left. Dark if the style has none.',
  ...
  'ots.2': {
    title: 'OTS 2',
    body: 'Recalls the style\'s second suggested panel setup: voice, on/off, volume and octave for Right 1–3 and Left.',
  ...
  'ots.3': {
    title: 'OTS 3',
    body: 'Recalls the style\'s third suggested panel setup: voice, on/off, volume and octave for Right 1–3 and Left.',
  ...
  'ots.4': {
    title: 'OTS 4',
    body: 'Recalls the style\'s fourth suggested panel setup: voice, on/off, volume and octave for Right 1–3 and Left.',
  ...
  'ots.link': {
    title: 'OTS Link',
    body: 'When on, Main A–D recall OTS 1–4 automatically, and changing style picks the setting for the Main that\'s playing.',
    genos: 'OTS LINK',
    keys: ['F10'],
  ...
  'mixer.panel.right1': {
    ...
    body: 'Right 1\'s volume (CC 7 on channel 1).',
  ...
  'mixer.panel.right2': {
    ...
    body: 'Right 2\'s volume (CC 7 on channel 3).',
  ...
  'mixer.panel.right3': {
    ...
    body: 'Right 3\'s volume (CC 7 on channel 4).',
  ...
  'mixer.panel.left': {
    title: 'Left volume',
    body: 'Left\'s volume (CC 7 on channel 2). Under Manual Bass this is the bass\'s level too.',
  ...
  'mixer.style.volume': {
    ...
    body: 'This band part\'s volume (its CC 7). Loading a style sets the style\'s own levels; a pattern that changes its volume moves the fader too, until you move it yourself.',
  ...
  'mixer.master': {
    title: 'Master volume',
    body: 'The built-in synth\'s output level (100 = unity). A soft clipper keeps the output from hard clipping.',
    genos: 'MASTER VOLUME',
    keys: [],
  ...
  'settings.open': {
    title: 'Settings',
    body: 'Fingering, chord detection and split, audio output, SoundFont, synth mute and MIDI inputs.',
    genos: null,
    keys: [],
    launchkey: null,
  },
