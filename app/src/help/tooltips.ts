...
const catalog = {
  ...
  'regist.save_bank': {
    title: 'Save bank',
    body: 'Saves the bank to its file in the Registration folder, or under the name you typed as a new file. Once a bank has a file, memorizing, renaming and sequence changes save themselves.',
  ...
  'regist.bank_name': {
    title: 'Bank name',
    body: 'The name to save the bank under. Saving with a new name makes a new file and leaves the old one as it was.',
    genos: null,
    keys: [],
    launchkey: null,
  },
  ...
  'regist.sequence_on': {
    ...
    body: 'Turns the bank\'s sequence on, so Regist + and Regist − step through it. It is saved with the bank.',
  ...
  'playlist.save': {
    title: 'Save playlist',
    body: 'Saves the set list in the order shown (a sorted list is saved sorted, and goes back to Normal), to its file or under the name you typed.',
    genos: 'Playlist: Save',
    keys: [],
    launchkey: null,
  },
  'playlist.name': {
    title: 'Playlist name',
    body: 'The name to save the set list under. A new name makes a new file.',
    genos: null,
    keys: [],
    launchkey: null,
  },
