...
| **Effect settings** | Opens this effect's own settings below the row: the reverb's time, pre-delay and tone. Choosing another type puts them back to that type's own values. | Mixer › Effect › Edit | — | — |
