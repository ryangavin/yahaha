...
| control | what it does | Genos | key | Launchkey |
|---|---|---|---|---|
| **Harmony/Arpeggio** | Turns the selected Keyboard Harmony type or arpeggio on or off for the keys right of the split. Turning it off stops the arpeggio at once; keys you hold keep their harmony notes until you let go. | HARMONY/ARPEGGIO | `R` | Pad page 3 (OTS/Parts), top row, pad 6 |
...
| **Next type** | Steps on through the Harmony types and then the arpeggios, as one list. | — | `Shift+R` | — |
...
| **Arpeggio Hold** | The pattern keeps playing after you let go of the keys. The next chord you play replaces it. | Arpeggio Hold | `Shift+H` | — |
...
| **Harmony/Arpeggio** | Opens the Keyboard Harmony and Arpeggio panel: the switch, the type and its settings. | HARMONY/ARPEGGIO, Keyboard Harmony/Arpeggio settings | — | Pad page 3 (OTS/Parts) has the on/off switch |
