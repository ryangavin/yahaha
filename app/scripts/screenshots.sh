...
shot settings-pedals 1440 900 "demo=1&open=settings&tab=pedals"
...
# The help footer (?tip= fills it as if that control were hovered).
shot help-footer-900x600 900 600 "demo=1&tip=transport.sync_start"
shot help-footer-900x600-light 900 600 "demo=1&theme=light&tip=transport.sync_start"
shot help-footer-1440 1440 900 "demo=1&tip=section.main_b"
shot help-footer-1440-light 1440 900 "demo=1&theme=light&tip=section.main_b"
shot help-footer-1920 1920 1080 "demo=1&tip=mixer.panel.right2"
shot help-footer-1920-light 1920 1080 "demo=1&theme=light&tip=mixer.panel.right2"
shot help-footer-drawer 1440 900 "demo=1&open=mixer&tip=mixer.master"
shot help-footer-browser 1440 900 "demo=0&open=browser&tip=browser.filter"
shot help-mode-light 1440 900 "demo=1&help=1&theme=light&tip=transport.sync_start"
shot help-mode-900x600 900 600 "demo=1&help=1&tip=transport.sync_start"
